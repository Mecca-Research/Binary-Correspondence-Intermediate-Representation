...
"bcir.target_capability"() {sym_name = "cpu", triple = "aarch64-linux-gnu",
  isa_features = ["neon"], lane_widths = [1, 4], warp = 0 : i32, cacheline = 64 : i32,
  gather_penalty = 8 : i32, affinity_domains = 8 : i32} : () -> ()
"bcir.isa_family"() {sym_name = "aarch64", name = "aarch64", endianness = "little",
  word_bits = 64 : i32, pointer_bits = 64 : i32} : () -> ()
"bcir.isa_feature"() {sym_name = "neon", isa = "aarch64", feature = "neon", kind = "simd"} : () -> ()
"bcir.isa_register_class"() {sym_name = "vreg128", isa = "aarch64", name = "v",
  count = 32 : i32, width_bits = 128 : i32, role = "vector"} : () -> ()
"bcir.isa_opcode"() {sym_name = "aarch64_fadd_v4f32", isa = "aarch64",
...
"bcir.target_lower_contract"() {sym_name = "lower_vec_add_neon", target = "cpu",
...
// CHECK: "bcir.isa_family"
// CHECK: "bcir.isa_opcode"

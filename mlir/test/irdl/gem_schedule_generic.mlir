...
"bcir.gem.schedule"() {sym_name = "sched_eft", plan = "plan0", mode = "eft",
  makespan = 11 : i64, knee = 2 : i32} : () -> ()
"bcir.gem.schedule"() {sym_name = "sched_tokens", plan = "plan0", mode = "tokens",
  makespan = 8 : i64, knee = 2 : i32, pipeline_depth = 2 : i32} : () -> ()
"bcir.gem.prefetch"() {sym_name = "dbpf0_1", distance = 4 : i32, targets = ["B"],
  hint = "T1", pattern = "double_buffer", buffers = 2 : i32} : () -> ()
"bcir.gem.lane_segment"() {sym_name = "seg0", claim = "add", phase = "p0",

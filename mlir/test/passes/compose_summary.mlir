...
bcir.module @compose {
  ...
  bcir.registry @RES {
    ...
    bcir.resource @H1 { rid = 20 : i32, domain_kind = #bcir.domain<hbm>, shape = array<i64: 1024>, layout = #bcir.layout<soa> }
    bcir.resource @H2 { rid = 21 : i32, domain_kind = #bcir.domain<hbm>, shape = array<i64: 1024>, layout = #bcir.layout<soa> }
    bcir.resource @H3 { rid = 22 : i32, domain_kind = #bcir.domain<hbm>, shape = array<i64: 1024>, layout = #bcir.layout<soa> }
  }

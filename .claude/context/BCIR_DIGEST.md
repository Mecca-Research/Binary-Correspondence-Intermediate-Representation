...
### docs/ heading map
- **BCIR_DRIVER_KERNEL_ROADMAP.md** (564L): 0. The one-paragraph orientation · Part I — The pre-driver hardening gate (Phase 0: do this fir · Part II — The language-placement model (the "more important  · Part III — Kernel/firmware dependency ordering (what's befor · Part IV — The sequenced slice plan · 5. Decision summary · Part V — Kernel feasibility audit: adaptive drivers, multi-b · Part V — BCIR kernel feasibility audit + the Linux compatibi

...
recomputed at the trust boundaries, `static_memory.digests.2048` 3 → 1; G11 and G5 are next)
...
| Metric | Value |
|---|---|
| Static Python `test_*` function inventory | **3665** across 260 files |
...
- **docs/BCIR_ASN1_X690_ABI.md** (333L): 1. The stance: DER out, BER in · 2. Coverage · 3. The BCIR-StreamPack module · 3a. The DER → native fast path · 4. The BCIR-ArtifactBundle module · 5. The laws · 6. The law rail (R24) · 7. Trust boundary · 8. Transfer syntax identity · 9. Validation
...
- **docs/DEVELOPMENT_HISTORY.md** (588L): 1. The development method · 2. The PR arc (eras) · 3. Condensed dated changelog · 4. Capability closure ledger migrated from the former master · 5. Where the detailed notes live now
...
- **docs/PARITY.md** (404L): Enum value parity (normative) · Concept parity · Python ↔ C artifact and runtime parity · Python ↔ C frontend twin (`runtime/c/`) · Worked-example parity · Generated, adversarial parity (the proof, not the hope) · How parity is enforced today
...
- **docs/security/laws.md** (1147L): The harvest protocol · The staleness rule (declared, not discretionary) · The laws · Campaign classification summary

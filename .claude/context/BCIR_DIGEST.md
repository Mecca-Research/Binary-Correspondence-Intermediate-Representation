...
| Metric | Value |
|---|---|
| Static Python `test_*` function inventory | **3584** across 258 files |
| Static MLIR ODS op-definition inventory (`mlir/include/BCIR/*.td`) | **133** |
| Static registered-pass inventory | **37** |
| Static MLIR fixture inventory (`mlir/test/`) | **124** files; 378 `expected-error` markers |
...
- **docs/DEVELOPMENT_HISTORY.md** (493L): 1. The development method · 2. The PR arc (eras) · 3. Condensed dated changelog · 4. Capability closure ledger migrated from the former master · 5. Where the detailed notes live now
...
- **docs/security/laws.md** (892L): The harvest protocol · The staleness rule (declared, not discretionary) · The laws · Campaign classification summary

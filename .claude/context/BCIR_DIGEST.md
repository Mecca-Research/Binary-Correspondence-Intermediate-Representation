...
| Metric | Value |
|---|---|
| Static Python `test_*` function inventory | **3568** across 257 files |
...
- **docs/DEVELOPMENT_HISTORY.md** (480L): 1. The development method · 2. The PR arc (eras) · 3. Condensed dated changelog · 4. Capability closure ledger migrated from the former master · 5. Where the detailed notes live now
...
- **docs/security/laws.md** (813L): The harvest protocol · The staleness rule (declared, not discretionary) · The laws · Campaign classification summary

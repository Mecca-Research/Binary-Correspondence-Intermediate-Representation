...
| Metric | Value |
|---|---|
| Static Python `test_*` function inventory | **3874** across 275 files |
...
- **docs/DEVELOPMENT_HISTORY.md** (919L): 1. The development method · 2. The PR arc (eras) · 3. Condensed dated changelog · 4. Capability closure ledger migrated from the former master · 5. Where the detailed notes live now
...
- **docs/PARITY.md** (418L): Enum value parity (normative) · Concept parity · Python ↔ C artifact and runtime parity · Python ↔ C frontend twin (`runtime/c/`) · Worked-example parity · Generated, adversarial parity (the proof, not the hope) · How parity is enforced today
...
- **docs/kernel/BCIR_PLANNER_ABI.md** (230L): Conventions · BKPI — the planner input · BKPR — the realization · The planner, step by step · Gates · Not claimed
...
- **docs/security/laws.md** (1480L): The harvest protocol · The staleness rule (declared, not discretionary) · The laws · Campaign classification summary

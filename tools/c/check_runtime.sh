...
for fx in cfront_regmap.c cfront_array.c cfront_array2d.c cfront_deref.c cfront_callgraph.c cfront_typedef.c cfront_enum.c cfront_ternary.c cfront_sizeof.c cfront_cast.c cfront_alignof.c cfront_static.c cfront_global.c cfront_atomic.c cfront_cmpxchg.c cfront_driver.c cfront_driver_uart.c; do

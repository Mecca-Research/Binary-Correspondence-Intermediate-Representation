...
for fx in cfront_regmap.c cfront_array.c cfront_callgraph.c cfront_branch.c cfront_while.c cfront_macros.c cfront_ppinc.c cfront_structret.c cfront_packed.c cfront_atomic.c cfront_cmpxchg.c; do  # L1-L8 + §5.8 atomics/CAS
...
for fx in cfront_regmap.c cfront_array.c cfront_callgraph.c cfront_atomic.c cfront_cmpxchg.c; do

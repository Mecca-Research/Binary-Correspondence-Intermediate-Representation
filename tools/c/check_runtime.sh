...
for fx in cfront_regmap.c cfront_array.c cfront_callgraph.c cfront_branch.c cfront_while.c cfront_macros.c cfront_ppinc.c cfront_structret.c cfront_packed.c cfront_typedef.c cfront_enum.c cfront_union.c cfront_atomic.c cfront_cmpxchg.c cfront_driver.c; do  # L1-L8 + type-model + §5.8 + Phase D driver
...
for fx in cfront_regmap.c cfront_array.c cfront_callgraph.c cfront_typedef.c cfront_enum.c cfront_atomic.c cfront_cmpxchg.c cfront_driver.c; do

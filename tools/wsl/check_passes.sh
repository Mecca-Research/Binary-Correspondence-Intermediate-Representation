...
echo "[passes] R22/R23 rung-5 LLM decode ops (embedding/rmsnorm/rope/gqa_attention/kv_cache: odd-dim rope, ragged head groups, over-full cache, extent + d_k + kv-head seam lies; legal chains)"

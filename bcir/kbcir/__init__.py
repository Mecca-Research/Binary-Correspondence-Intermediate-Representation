...
_EXPORTS: dict[str, tuple[str, ...]] = {
    ...
    "fusion": ("FUSIBLE_ACTIVATIONS", "NON_FUSIBLE_ACTIVATIONS", "FusionCertificate",
    ...
    "differential": ("CheckResult", "Mismatch", "Report", "check_module",
                     ...
                     "gen_illegal_module", "law_select", "run_campaign",
                     "run_verifier_campaign", "shrink"),
    ...
    "static_memory": ("BankMemoryPlan", "ResourceBankBinding", "StaticAllocation",
                      "StaticMemoryPlan", "plan_static_memory", "verify_static_memory_plan"),
    "hardware_rl": ("HardwareEpisode", "HardwareOutcome", "HardwarePreference",
                    "HardwarePromotionCertificate", "HardwareRewardPolicy",
                    "HardwareSearchResult", "HardwareTopology", "TelemetryToken",
                    "bounded_mcts", "certify_hardware_promotion",
                    "encode_candidate_features", "encode_hardware_topology",
                    "hardware_context_digest", "outcomes_to_preferences"),
    "ham": ("HAMAccess", "HAMAction", "HAMBankPeak", "HAMExecutionPlan",
            "HAMResource", "HAMWorkload", "LoweredHAMExecution",
            "lower_ham_workload", "verify_ham_plan"),
    "context_shard": ("ContextShardActivation", "ContextShardCatalog",
                      "ContextShardEntry", "ContextShardManifest",
                      "certify_context_activation", "read_context_shard_catalog",
                      "read_context_shard_manifest", "verify_context_payload",
                      "write_context_shard_catalog", "write_context_shard_manifest"),
    ...
    "byte_latent": (
        ...
        "TensorShape", "UnicodeByteReference", "assess_byte_latent",
        "assess_mambabyte", "choose_byte_ingest", "decode_raw_bytes",
        "discounted_batch_advantages", "encode_raw_sequence", "lower_byte_latent",
        "plan_byteified_transplant", "verify_byte_draft"),
    "sequence_interfaces": (
        ...
        "canonical_substring_candidate", "decode_causal_series",
        "encode_causal_series", "lower_growth_stage", "pareto_sequence_interfaces",

...
_EXPORTS: dict[str, tuple[str, ...]] = {
    ...
    "c_kernel": ("compile_and_run_c", "compile_and_run_qfixed_c", "emit_gather_kernel_c",
                 "emit_header_c", "emit_kernel_c", "emit_qfixed_kernel_c",
                 "emit_qfixed_selfcheck_c", "emit_reduce_c", "emit_selfcheck_c",
                 "emit_strided_c", "find_reduce", "find_strided", "SpatialBinding",
                 "SpatialPlan", "optimize_spatial", "is_pim_target"),

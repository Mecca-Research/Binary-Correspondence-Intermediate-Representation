...
from bcir.kbcir.activation import (
    ACTIVATIONS,
    EXACT_ACTIVATIONS,
    TRANSCENDENTAL_ACTIVATIONS,
    ActivationSpec,
    activation_reference,
    activation_via_bridge,
    bottleneck,
    check_activation,
    cost_of,
    cost_vector,
...
def test_check_activation_accepts_well_formed_claims():
    ...
    assert (
        check_activation(ActivationSpec("gelu", (2, 3), "f32", 0), (2, 3), "f32", (2, 3), "f32")
        == []
    )
    assert (
        check_activation(ActivationSpec("softmax", (2, 5), "f32", 5), (2, 5), "f32", (2, 5), "f32")
        == []
    )
...
def test_check_activation_rejects_malformed_claims():
    ...
    assert check_activation(
        ActivationSpec("softmax", (2, 5), "f32", 4), (2, 5), "f32", (2, 5), "f32"
    )

...
_MODULES = [
    ...
    "bcir.tests.test_telemetry_envelope",
    "bcir.tests.test_signal_table",
    ...
    "bcir.tests.test_asn1_control_plane",
    ...
    "bcir.tests.test_structural_corpus",
    ...
    "bcir.tests.test_asn1_ecn_encode",

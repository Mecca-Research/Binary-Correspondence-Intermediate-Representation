...
| Path     | What it is |
|----------|------------|
| `bcir/`  | the **executable conformance oracle** (Python, dependency-free, runnable today): the K_BCIR optimizer, GEM hydration/execution, M5 event transduction, ROP/MAP front-ends, LLVM lowering (AOT clang + JIT lli), the data-DNA telemetry loop, and the R1–R21 verifier reference |

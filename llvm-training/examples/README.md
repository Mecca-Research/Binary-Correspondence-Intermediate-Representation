...
| `llvm-training/06-metadata/examples/debug-info-optimization.ll` | `llvm-as llvm-training/06-metadata/examples/debug-info-optimization.ll -o /dev/null` |
...
| `llvm-training/06-metadata/examples/debug-variable-fragments.ll` | `llvm-as llvm-training/06-metadata/examples/debug-variable-fragments.ll -o /dev/null` |
...
| `llvm-training/06-metadata/examples/profile-entry-count.ll` | `llvm-as llvm-training/06-metadata/examples/profile-entry-count.ll -o /dev/null` |
...
| `llvm-training/07-optimization/examples/memoryssa-alias-shape.ll` | `llvm-as llvm-training/07-optimization/examples/memoryssa-alias-shape.ll -o /dev/null` |
...
| `llvm-training/07-optimization/examples/sccp-after.ll` | `llvm-as llvm-training/07-optimization/examples/sccp-after.ll -o /dev/null` |
| `llvm-training/07-optimization/examples/sccp-before.ll` | `llvm-as llvm-training/07-optimization/examples/sccp-before.ll -o /dev/null` |
...
| `llvm-training/12-backend-jit/examples/custom-bcir-intrinsic-jit.ll` | `llvm-as llvm-training/12-backend-jit/examples/custom-bcir-intrinsic-jit.ll -o /dev/null` |

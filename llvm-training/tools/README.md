...
| `verify-manifest.sh` | Compares discovered standalone `*/examples/*.ll` files against `llvm-training/examples/README.md` so new examples cannot land without manifest documentation. | `bash`, `python3` |

...
tool opens a counter and reports what the kernel said.
    ...
    python3 llvm-training/tools/probe-hardware-counters.py --format json
    python3 llvm-training/tools/probe-hardware-counters.py --require-counters
...
def probe() -> dict:
    record: dict = {
        "schema": "llvm-training/hardware-counter-probe/v1",
        "host": {

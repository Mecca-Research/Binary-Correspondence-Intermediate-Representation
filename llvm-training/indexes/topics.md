...
| BCIR MLIR type conversion and descriptor-vs-handle lowering | [`14-mlir-bridge/05-type-conversion.md`](../14-mlir-bridge/05-type-conversion.md), [`14-mlir-bridge/examples/bcir-canonicalized.mlir`](../14-mlir-bridge/examples/bcir-canonicalized.mlir) |
| BCIR MLIR conversion patterns for edge topology, attributes, HAM hints, and register binding | [`14-mlir-bridge/06-conversion-patterns.md`](../14-mlir-bridge/06-conversion-patterns.md), [`14-mlir-bridge/examples/bcir-lowered-llvm-dialect.mlir`](../14-mlir-bridge/examples/bcir-lowered-llvm-dialect.mlir) |
| BCIR MLIR pass pipeline and verifier/diagnostic strategy | [`14-mlir-bridge/07-pass-pipeline.md`](../14-mlir-bridge/07-pass-pipeline.md), [`14-mlir-bridge/08-diagnostics-and-verification.md`](../14-mlir-bridge/08-diagnostics-and-verification.md) |
| BCIR MLIR end-to-end source, canonical, LLVM dialect, and textual LLVM IR trace | [`14-mlir-bridge/09-bcir-mlir-end-to-end.md`](../14-mlir-bridge/09-bcir-mlir-end-to-end.md), [`14-mlir-bridge/examples/bcir-final.ll`](../14-mlir-bridge/examples/bcir-final.ll) |

...
| MLIR conversion patterns for BCIR graph/edge/attribute ops | [`14-mlir-bridge/06-conversion-patterns.md`](../14-mlir-bridge/06-conversion-patterns.md), [`14-mlir-bridge/examples/bcir-conversion-pipeline.mlir`](../14-mlir-bridge/examples/bcir-conversion-pipeline.mlir) |
| MLIR pass pipeline diagnostics and final LLVM IR snapshot | [`14-mlir-bridge/07-pass-pipeline-and-diagnostics.md`](../14-mlir-bridge/07-pass-pipeline-and-diagnostics.md), [`14-mlir-bridge/08-end-to-end-bcir-lowering.md`](../14-mlir-bridge/08-end-to-end-bcir-lowering.md), [`14-mlir-bridge/examples/bcir-final.ll`](../14-mlir-bridge/examples/bcir-final.ll) |

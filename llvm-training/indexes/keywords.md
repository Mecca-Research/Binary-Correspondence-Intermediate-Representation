...
| `deopt`, `funclet`, `gc-live`, `convergencectrl`, `clang.arc.attachedcall` | [`13-advanced-ir/07-operand-bundles.md`](../13-advanced-ir/07-operand-bundles.md), [`13-advanced-ir/03-special-types-and-tokens.md#convergence-control`](../13-advanced-ir/03-special-types-and-tokens.md#convergence-control) |
| `llvm.experimental.stackmap`, `llvm.experimental.patchpoint.*` | [`12-backend-jit/06-custom-bcir-intrinsics.md`](../12-backend-jit/06-custom-bcir-intrinsics.md), [`reference/intrinsics-quickref.md#stackmap-and-patchpoint-intrinsics`](../reference/intrinsics-quickref.md#stackmap-and-patchpoint-intrinsics) |
| `llvm.matrix.*`, `llvm.coro.*`, `llvm.experimental.gc.*`, `llvm.experimental.convergence.*` | [`13-advanced-ir/03-special-types-and-tokens.md`](../13-advanced-ir/03-special-types-and-tokens.md), [`reference/intrinsics-quickref.md`](../reference/intrinsics-quickref.md) |
| `va_arg`, `llvm.va_start`, `llvm.va_end` | [`reference/instruction-quickref.md`](../reference/instruction-quickref.md), [`12-backend-jit/01-codegen-pipeline.md#varargs-and-abi-variance`](../12-backend-jit/01-codegen-pipeline.md#varargs-and-abi-variance) |

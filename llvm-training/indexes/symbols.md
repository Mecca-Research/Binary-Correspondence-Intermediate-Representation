...
| `token` | Opaque control value for EH, coroutine, GC statepoint, and convergence-control IR | [`02-types/01-primitive-types.md`](../02-types/01-primitive-types.md), [`13-advanced-ir/03-special-types-and-tokens.md`](../13-advanced-ir/03-special-types-and-tokens.md), [`reference/intrinsics-quickref.md#convergence-intrinsics`](../reference/intrinsics-quickref.md#convergence-intrinsics) |
...
| `@llvm.masked.store.*` | Predicated vector store intrinsic | [`09-vectorization/07-masked-and-interleaved-access.md`](../09-vectorization/07-masked-and-interleaved-access.md), [`reference/intrinsics-quickref.md`](../reference/intrinsics-quickref.md) |
| `@llvm.matrix.*` | Matrix intrinsic namespace for flattened matrix operations | [`reference/intrinsics-quickref.md#matrix-intrinsics`](../reference/intrinsics-quickref.md#matrix-intrinsics), [`13-advanced-ir/examples/matrix-intrinsics-sketch.ll`](../13-advanced-ir/examples/matrix-intrinsics-sketch.ll) |
| `@llvm.coro.*` | Coroutine intrinsic namespace for presplit coroutine lowering | [`13-advanced-ir/03-special-types-and-tokens.md#coroutine-tokens-and-lowering-phases`](../13-advanced-ir/03-special-types-and-tokens.md#coroutine-tokens-and-lowering-phases), [`13-advanced-ir/examples/coroutine-outline.ll`](../13-advanced-ir/examples/coroutine-outline.ll) |
| `@llvm.experimental.convergence.*`, `"convergencectrl"` | Convergence-control token intrinsics and operand bundle | [`13-advanced-ir/03-special-types-and-tokens.md#convergence-control`](../13-advanced-ir/03-special-types-and-tokens.md#convergence-control), [`reference/intrinsics-quickref.md#convergence-intrinsics`](../reference/intrinsics-quickref.md#convergence-intrinsics) |

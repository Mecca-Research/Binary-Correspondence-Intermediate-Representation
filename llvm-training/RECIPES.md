...
| Interpret PGO/LTO/BOLT optimized binaries | [`07-optimization/06-pgo-lto-bolt.md`](07-optimization/06-pgo-lto-bolt.md), [`07-optimization/07-bolt-layout-walkthrough.md`](07-optimization/07-bolt-layout-walkthrough.md) | [`07-optimization/examples/bolt-layout-demo.c`](07-optimization/examples/bolt-layout-demo.c), [`tools/smoke-bolt.sh`](tools/smoke-bolt.sh), [`06-metadata/03-profile-and-optimization-metadata.md`](06-metadata/03-profile-and-optimization-metadata.md), [`15-binary-analysis/02-dynamic-traces-and-counters.md`](15-binary-analysis/02-dynamic-traces-and-counters.md) |

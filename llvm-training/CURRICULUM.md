...
1. [`14-mlir-bridge/README.md`](14-mlir-bridge/README.md) — path overview and example map
...
6. [`14-mlir-bridge/05-type-conversion-and-materialization.md`](14-mlir-bridge/05-type-conversion-and-materialization.md) — BCIR handle/descriptor type conversion and cast materialization
7. [`14-mlir-bridge/06-conversion-patterns.md`](14-mlir-bridge/06-conversion-patterns.md) — graph lookup, edge, attribute, HAM, and register-binding rewrite patterns
8. [`14-mlir-bridge/07-pass-pipeline-and-diagnostics.md`](14-mlir-bridge/07-pass-pipeline-and-diagnostics.md) — staged pipeline checkpoints and diagnostics
9. [`14-mlir-bridge/08-end-to-end-bcir-lowering.md`](14-mlir-bridge/08-end-to-end-bcir-lowering.md) — BCIR graph fragment through final LLVM IR; includes [`examples/bcir-final.ll`](14-mlir-bridge/examples/bcir-final.ll)
...
07-optimization/  →  09-vectorization/
        ↓                    ↓
08-pitfalls/      →  10-grammar/  →  11-concurrency/  →  12-backend-jit/  →  14-mlir-bridge/  →  15-binary-analysis/  →  reference/
```

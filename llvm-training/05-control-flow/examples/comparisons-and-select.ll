...
;
; Companion chapter: llvm-training/05-control-flow/06-comparisons-and-select.md
;
;   llvm-as llvm-training/05-control-flow/examples/comparisons-and-select.ll -o /dev/null
;   opt -passes=verify -S llvm-training/05-control-flow/examples/comparisons-and-select.ll -o /dev/null
;

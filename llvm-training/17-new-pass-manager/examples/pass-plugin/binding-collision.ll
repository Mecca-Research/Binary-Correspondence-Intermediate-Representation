...
;   llvm-as   llvm-training/17-new-pass-manager/examples/pass-plugin/binding-collision.ll -o /dev/null
;   opt -passes=verify -S llvm-training/17-new-pass-manager/examples/pass-plugin/binding-collision.ll -o /dev/null
;
...
;       llvm-training/17-new-pass-manager/examples/pass-plugin/binding-collision.ll

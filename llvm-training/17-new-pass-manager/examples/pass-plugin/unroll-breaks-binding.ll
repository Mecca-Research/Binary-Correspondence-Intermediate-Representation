...
;   llvm-as   llvm-training/17-new-pass-manager/examples/pass-plugin/unroll-breaks-binding.ll -o /dev/null
;   opt -passes=verify -S llvm-training/17-new-pass-manager/examples/pass-plugin/unroll-breaks-binding.ll -o /dev/null
;
...
; llvm-training/tools/build-pass-plugin.sh asserts the stable form.

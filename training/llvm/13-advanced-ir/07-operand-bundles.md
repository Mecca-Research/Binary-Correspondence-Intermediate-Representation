...
```bash
llvm-as training/llvm/13-advanced-ir/examples/operand-bundles-deopt.ll -o /dev/null
llvm-as training/llvm/13-advanced-ir/examples/operand-bundles-funclet.ll -o /dev/null
opt -passes=verify training/llvm/13-advanced-ir/examples/operand-bundles-deopt.ll -o /dev/null
opt -passes=verify training/llvm/13-advanced-ir/examples/operand-bundles-funclet.ll -o /dev/null
```

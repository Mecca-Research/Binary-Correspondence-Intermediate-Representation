...
```sh
cat training/llvm/09-vectorization/examples/masked-load-store-after-vectorize.ll
cat training/llvm/09-vectorization/examples/interleaved-access-after-vectorize.ll
```

...
;
; Try:
;   opt -S -passes=loop-vectorize sum-loop-before.ll -o -
;   opt -S -passes=loop-vectorize -force-vector-width=4 sum-loop-before.ll -o -
;
; Expected observation:
;   Before vectorization, the loop body uses scalar i32 loads, scalar add
;   instructions, and a scalar induction variable.

source_filename = "sum-loop-before.ll"

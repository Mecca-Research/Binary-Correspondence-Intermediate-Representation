...
; Assemble: llvm-as training/llvm/06-metadata/examples/debug-location.ll -o /dev/null
...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "training/llvm", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug)

...
; Assemble: llvm-as training/llvm/06-metadata/examples/debug-variable-fragments.ll -o /dev/null
;
...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "training/llvm", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug)
!1 = !DIFile(filename: "debug-variable-fragments.c", directory: "/workspace/examples")
!2 = !{i32 7, !"Dwarf Version", i32 5}
!3 = !{i32 2, !"Debug Info Version", i32 3}
!4 = !{!"training/llvm metadata example"}

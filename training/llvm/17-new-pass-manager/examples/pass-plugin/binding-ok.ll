...
;   llvm-as   training/llvm/17-new-pass-manager/examples/pass-plugin/binding-ok.ll -o /dev/null
;   opt -passes=verify -S training/llvm/17-new-pass-manager/examples/pass-plugin/binding-ok.ll -o /dev/null
;
...
;       training/llvm/17-new-pass-manager/examples/pass-plugin/binding-ok.ll

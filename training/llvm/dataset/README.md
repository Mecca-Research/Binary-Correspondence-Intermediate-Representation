...
numbered exercises and declarative grading manifests in `training/llvm/`. It is
...
python3 training/llvm/tools/export-exercise-dataset.py \
  ...
  --output /tmp/training-llvm-eval-v1.jsonl
```
...
python3 training/llvm/tools/export-exercise-dataset.py \
  ...
  --output /tmp/training-llvm-eval-v1-test-with-solutions.jsonl
```

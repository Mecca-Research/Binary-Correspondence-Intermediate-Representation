...
`training/llvm/tools/generate-exercise-variants.py` starts with a deliberately
...
python3 training/llvm/tools/generate-exercise-variants.py \
  --seed 20260612 \
  --budget 5 \
  --output /tmp/training-llvm-variants.jsonl \
  --report /tmp/training-llvm-variants-report.json
```

...
| Category quick reference for math, bit operations, overflow, memory, lifetime, atomics, reductions, constrained FP, stackmaps/patchpoints, matrix, coroutine, GC statepoint, convergence, target-specific namespaces, EH, and debug info | [`intrinsics-quickref.md`](intrinsics-quickref.md) |
...
| Runtime/advanced token families | `llvm.experimental.stackmap`, `llvm.experimental.patchpoint.*`, `llvm.matrix.*`, `llvm.coro.*`, `llvm.experimental.gc.*`, `llvm.experimental.convergence.*` | [`intrinsics-quickref.md#stackmap-and-patchpoint-intrinsics`](intrinsics-quickref.md#stackmap-and-patchpoint-intrinsics), [`intrinsics-quickref.md#matrix-intrinsics`](intrinsics-quickref.md#matrix-intrinsics), [`intrinsics-quickref.md#coroutine-intrinsics`](intrinsics-quickref.md#coroutine-intrinsics), [`intrinsics-quickref.md#gc-statepoint-intrinsics`](intrinsics-quickref.md#gc-statepoint-intrinsics), [`intrinsics-quickref.md#convergence-intrinsics`](intrinsics-quickref.md#convergence-intrinsics) |
| Target-specific, EH, debug | `llvm.x86.*`, `llvm.eh.*`, `llvm.dbg.*` | [`intrinsics-quickref.md#target-specific-intrinsic-naming-patterns`](intrinsics-quickref.md#target-specific-intrinsic-naming-patterns), [`intrinsics-quickref.md#exception-handling`](intrinsics-quickref.md#exception-handling), [`intrinsics-quickref.md#debug-info`](intrinsics-quickref.md#debug-info) |

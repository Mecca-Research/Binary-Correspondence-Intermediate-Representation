...
seeded, so the same input file always produces the same interval.
    ...
    python3 training/llvm/tools/analyze-benchmark-samples.py samples.json
    python3 training/llvm/tools/analyze-benchmark-samples.py samples.json --format json
    python3 training/llvm/tools/analyze-benchmark-samples.py samples.json --gate

Input schema: see training/llvm/21-performance-methodology/examples/README.md.
"""
...
SCHEMA = "training/llvm/benchmark-samples/v1"

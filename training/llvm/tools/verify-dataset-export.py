...
def main() -> int:
    ...
    exporter = repo_root / "training/llvm/tools/export-exercise-dataset.py"
    schema_path = repo_root / "training/llvm/dataset/schema-v1.json"
    split_path = repo_root / "training/llvm/dataset/splits-v1.json"
    errors: list[str] = []
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="training-llvm-dataset-") as temporary:
            temp = Path(temporary)

...
report={"schema_version":1,"kind":"training-llvm-bolt-experiment","generated_at_utc":datetime.datetime.now(datetime.timezone.utc).isoformat(),"status":os.environ["STATUS"],"reason":os.environ["REASON"] or None,"tools":tools,"artifacts":artifacts}

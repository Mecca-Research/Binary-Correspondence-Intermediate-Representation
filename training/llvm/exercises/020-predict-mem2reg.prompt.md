...
```sh
training/llvm/exercises/020-predict-mem2reg.input.ll
```
...
```sh
opt -S -passes=mem2reg training/llvm/exercises/020-predict-mem2reg.input.ll -o -
```
...
```sh
llvm-as -disable-output training/llvm/exercises/020-predict-mem2reg.after-mem2reg.ll
```

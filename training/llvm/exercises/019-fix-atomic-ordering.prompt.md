...
```sh
training/llvm/exercises/019-fix-atomic-ordering.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/019-fix-atomic-ordering.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/019-fix-atomic-ordering.solution.ll
```

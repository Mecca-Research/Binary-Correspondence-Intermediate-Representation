...
```sh
training/llvm/exercises/040-debug-gaadmsf-lowering.invalid.ll.txt
```
...
```sh
llvm-as training/llvm/exercises/040-debug-gaadmsf-lowering.invalid.ll.txt -o /tmp/040-debug-gaadmsf-lowering.invalid.bc && opt -passes=verify /tmp/040-debug-gaadmsf-lowering.invalid.bc -o /dev/null
```
...
```sh
llvm-as -disable-output training/llvm/exercises/040-debug-gaadmsf-lowering.solution.ll
```

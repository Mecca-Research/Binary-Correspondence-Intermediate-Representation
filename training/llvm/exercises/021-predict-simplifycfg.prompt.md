...
```sh
training/llvm/exercises/021-predict-simplifycfg.input.ll
```
...
```sh
opt -S -passes=simplifycfg training/llvm/exercises/021-predict-simplifycfg.input.ll -o -
```
...
```sh
llvm-as -disable-output training/llvm/exercises/021-predict-simplifycfg.after-simplifycfg.ll
```

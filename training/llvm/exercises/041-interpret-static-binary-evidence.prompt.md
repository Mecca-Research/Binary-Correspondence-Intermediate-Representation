...
- `training/llvm/15-binary-analysis/fixtures/generated/linear-arithmetic.csv`
- `training/llvm/15-binary-analysis/fixtures/generated/branch-and-call.csv`
- `training/llvm/15-binary-analysis/evidence-manifest.json`
...
```sh
cat training/llvm/exercises/041-interpret-static-binary-evidence.solution.md
```

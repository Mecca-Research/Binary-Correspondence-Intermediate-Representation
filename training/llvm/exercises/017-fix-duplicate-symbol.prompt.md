...
```sh
training/llvm/exercises/017-fix-duplicate-symbol.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/017-fix-duplicate-symbol.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/017-fix-duplicate-symbol.solution.ll
```

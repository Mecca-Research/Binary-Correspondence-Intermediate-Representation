...
```sh
training/llvm/exercises/016-fix-phi-predecessor.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/016-fix-phi-predecessor.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/016-fix-phi-predecessor.solution.ll
```

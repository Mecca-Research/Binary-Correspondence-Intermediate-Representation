...
```sh
training/llvm/exercises/018-fix-immarg-intrinsic.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/018-fix-immarg-intrinsic.invalid.ll.txt
```
...
```sh
llvm-as -disable-output training/llvm/exercises/018-fix-immarg-intrinsic.solution.ll
```

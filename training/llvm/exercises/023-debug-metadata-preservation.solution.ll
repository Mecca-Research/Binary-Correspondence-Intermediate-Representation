...
!0 = distinct !DICompileUnit(language: DW_LANG_C, file: !1, producer: "training/llvm", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug)
!1 = !DIFile(filename: "debug-preserve.c", directory: "/training/llvm/exercises")

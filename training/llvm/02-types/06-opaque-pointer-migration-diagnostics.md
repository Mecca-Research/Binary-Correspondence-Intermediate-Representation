...
```sh
llvm-as training/llvm/02-types/examples/opaque-pointer-after.ll -o /tmp/opaque-pointer-after.bc
opt -passes=verify -disable-output /tmp/opaque-pointer-after.bc
opt -S training/llvm/02-types/examples/opaque-pointer-after.ll -o -
```

...
```bash
llvm-as training/llvm/bcir-mapping/examples/normal-form-valid.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/normal-form-valid.ll -o /dev/null

...
```bash
llvm-as training/llvm/bcir-mapping/examples/vertex-edge-attribute.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/register-binding.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/mixed-stride.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/graph-fragment-struct-gep.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/claim-resource-lookup.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/ham-hint-prefetch.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/bcir-op-runtime-wrapper.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/mixed-stride-byte-offset.ll -o /dev/null
llvm-as training/llvm/bcir-mapping/examples/diagnostic-metadata-preservation.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/vertex-edge-attribute.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/register-binding.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/mixed-stride.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/graph-fragment-struct-gep.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/claim-resource-lookup.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/ham-hint-prefetch.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/bcir-op-runtime-wrapper.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/mixed-stride-byte-offset.ll -o /dev/null
opt -passes=verify training/llvm/bcir-mapping/examples/diagnostic-metadata-preservation.ll -o /dev/null
```

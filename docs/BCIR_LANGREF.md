...
invariant R14–R25 also hold to). Oracle twins: `asn1.schema` and `asn1.der`.
...
*A dated, source-level system report that used to be appended here (HEAD `997511de`, 2026-08-10)
now lives at [`research/BCIR_SYSTEM_REPORT_2026-08-10.md`](research/BCIR_SYSTEM_REPORT_2026-08-10.md).
The current capability snapshot is [`REPO_CURRENT_STATE_AUDIT.md`](REPO_CURRENT_STATE_AUDIT.md)
and the live inventory is generated [`STATUS.md`](STATUS.md).*

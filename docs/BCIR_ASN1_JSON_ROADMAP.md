...
> **Status:** canonical execution roadmap for schema-bound JSON compilation. Its baseline was
> taken at [PR #670](https://github.com/Mecca-Research/Binary-Correspondence-Intermediate-Representation/pull/670)
> and the delivery table in §7 records what has landed since (J1–J6 are landed; J7 is blocked on
> device access, not design). A section describing a landed stage keeps its gate as the contract
> that stage met.
>
...
## 2. Source-backed baseline (taken at PR #670; §7 tracks what landed after it)

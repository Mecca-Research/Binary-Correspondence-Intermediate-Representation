...
| P2 bounded TMSAO | Stage 2: G2 **landed (S2-A)**, G4 **landed (S2-B — the first TMSAO-2 and TMSAO-1 certificates)**, G12 **landed (S2-C)**, G6, G13 |
